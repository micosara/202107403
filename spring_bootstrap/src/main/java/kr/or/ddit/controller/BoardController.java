...
public class BoardController {
	...
	public String regist(HttpServletRequest request, //BoardVO board,
		...
		BoardVO board = (BoardVO)XSSHttpRequestParameterAdapter.execute(request, 
																		BoardVO.class, true);
	...
	public String modifyPost(HttpServletRequest request, //BoardModifyCommand modifyReq,
		...
		=(BoardModifyCommand)XSSHttpRequestParameterAdapter.execute(request, 
													BoardModifyCommand.class, true);	
